...
class Creature:
    def __init__(self, name, species, accessories, health=100, hunger=100, age=1, energy=100, happiness=100, sanity=100, is_alive=True):
        self.name = name
    ...
    def check_status(self):
        if self.health <= 0 or self.hunger <= 0 or self.sanity <= 0:
            self.is_alive = False
